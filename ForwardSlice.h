...
namespace llvm {
    ...
    class ForwardSlice : public ModulePass {
    public:
        typedef std::set<SDGNode*> nodeSet_t;
        // Pass Indentifier 
        static char ID;
        ForwardSlice() : ModulePass(ID) {}
    ...
    private:
        ...
        bool markVerticesOfForwardSlice(SDG &sdg, nodeSet_t &resultSet);
        ...
        bool markReachingVerticesForForwardSlice(SDG &sdg, nodeSet_t &resultSet,
